...
namespace NP_UNIP
{
    public partial class frmAreaUsuario : Form
    {
        ...
        private void frmAreaUsuario_Load(object sender, EventArgs e)
        {
        ...
        private void DadosPaciente_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btnPesqPac_Au1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cm = new SqlCommand("SELECT * FROM Paciente", conec);
